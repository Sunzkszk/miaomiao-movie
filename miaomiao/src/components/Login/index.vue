<template>
    <div class="login_body">
        ...
        <div class="verify">
            <input type="text" class="verify_text" v-model="verifyImg" placeHolder="请输入您的验证码"> <img class="verify_img" @touchstart="handleToVerifyImg" src="/api2/users/verifyImg">
        </div>
        <div class="login_btn">
...
.login_body .verify{display: flex;height: 50px;margin-top: 2px;}
.login_body .verify .verify_text{width:50%;border:none;border-bottom: 1px #ccc solid;text-indent: 10px;outline: none;}
.login_body .verify .verify_img{width:50%;}
